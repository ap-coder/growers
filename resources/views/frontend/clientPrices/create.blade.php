                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.client-prices.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="upc" id="upc" value="{{ old('upc', '') }}">
                            @if($errors->has('upc'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('upc') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="qb_1" id="qb_1" value="{{ old('qb_1', '') }}">
                            @if($errors->has('qb_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qb_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="qb_2" id="qb_2" value="{{ old('qb_2', '') }}">
                            @if($errors->has('qb_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qb_2') }}
                                </div>
