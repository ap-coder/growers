@can('setting_access')
    <li class="nav-item has-treeview {{ request()->is("admin/settings*") || request()->is("admin/menu-builder*") ? "menu-open" : "" }}">
        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/settings*") || request()->is("admin/menu-builder*") ? "active" : "" }}" href="#">
