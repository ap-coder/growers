...
@section('content')
<section class="content-inner pt-0 z-index-unset overflow-hidden">
    ...
    <div class="container">
        <div class="clearfix">
            <ul id="masonry" class="lightgallery row">
                ...
                @endphp
                <li class="card-container col-xl-4 col-lg-4 col-md-6 m-b30 All {{ $categoryClasses }}">
...
$(document).ready(function() {
    $('.site-filters .filters li').on('click', function() {
        ...
        if (filterValue === '.All') {
            $('#masonry .card-container').show();
        } else {
            $('#masonry .card-container').hide();
            $('#masonry ' + filterValue).show();
        }
    });
});
</script>
