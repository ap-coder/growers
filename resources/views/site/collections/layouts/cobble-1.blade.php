        ...
        <div class="clearfix">
            <ul id="masonry" class="lightgallery row" data-masonry='{"percentPosition": true}'>
                ...
                @php
                    ...
                    // Cobble pattern: small, small, large, small, small, large...
                    $colClass = ($index % 3 == 2) ? 'col-xl-6 col-lg-6' : 'col-xl-3 col-lg-3';
                @endphp
                <li class="card-container {{ $colClass }} col-md-6 col-sm-6 m-b30 All {{ $categoryClasses }}">
                    <div class="portfolio-box style-2">
                        ...
                        <div class="dz-content {{ ($index % 3 != 2) ? 'w-100' : '' }}">
