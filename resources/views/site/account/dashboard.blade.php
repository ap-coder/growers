...
@section('title', 'Account Dashboard - Pacific Plant Growers')
        ...
        <div class="row">
            ...
            <section class="col-xl-9 account-wrapper">
                <div class="account-card">
                    <div class="m-b30">
                        <p>Hello <strong class="text-black">{{ auth()->user()->name }}</strong></p>
                        <p>From your account dashboard you can view your <a href="{{ route('site.account.orders') }}" class="text-underline">recent orders</a> and <a href="{{ route('site.account.profile') }}" class="text-underline">edit your account details</a>.</p>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="total-contain">
                                ...
                                <div class="total-detail">
                                    ...
                                    <h2 class="title">{{ $totalOrders ?? 0 }}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="total-contain">
                                <div class="total-icon">
                                    <svg width="33" height="27" viewBox="0 0 33 27" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M30.2253 12.8816H29.4827L28.6701 9.36514C28.376 8.10431 27.2552 7.22168 25.9662 7.22168H21.8474V3.84528C21.8474 2.03804 20.3764 0.581055 18.5831 0.581055H3.17237C1.46313 0.581055 0.0761719 1.96801 0.0761719 3.67717V20.0967C0.0761719 21.8058 1.46313 23.1928 3.17237 23.1928H4.29313C4.89555 25.1962 6.74485 26.6533 8.93037 26.6533C11.1159 26.6533 12.9792 25.1962 13.5816 23.1928C13.8455 23.1928 20.3459 23.1928 20.1942 23.1928C20.7966 25.1962 22.6459 26.6533 24.8315 26.6533C27.031 26.6533 28.8803 25.1962 29.4827 23.1928H30.2253C31.7663 23.1928 32.9992 21.9599 32.9992 20.4189V15.6555C32.9992 14.1145 31.7663 12.8816 30.2253 12.8816Z" fill="#FFBB38"></path></svg>
                                </div>
                                <div class="total-detail">
                                    <span class="text">Pending Orders</span>
                                    <h2 class="title">{{ $pendingOrders ?? 0 }}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('site.account.orders.show', $order->id) }}" class="btn btn-sm btn-outline-primary">View</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
