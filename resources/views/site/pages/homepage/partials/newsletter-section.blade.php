	...
	<section class="content-inner-1  overflow-hidden position-relative border-top">
		<div class="collection1 style-1 up-down"><img src="{{ asset('assets/images/collection/1.png') }}" alt=""></div>
		<div class="collection3 style-1 up-down"><img src="{{ asset('assets/images/collection/2.png') }}"  alt=""></div>
		<div class="container">
