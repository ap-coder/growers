...
<div class="card">
    <div class="card-header">
        <i class="fas fa-plus mr-1"></i> Create Variation Category
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route('admin.variation-categories.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('published') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="published" id="published" value="1" {{ old('published', 1) == 1 ? 'checked' : '' }}>
