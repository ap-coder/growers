...
<div class="form-group">
    <label>Content (displays on left)</label>
    <textarea name="content" class="form-control" rows="5">{{ $section->content }}</textarea>
</div>
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
...
<div class="form-group">
    <label>Image (displays on right)</label>
    <small class="text-muted d-block mb-2">Upload via Media Library after saving</small>
    @if($section->getFirstMediaUrl('section_image'))
        <img src="{{ $section->getFirstMediaUrl('section_image', 'preview') }}" class="img-thumbnail mb-2" style="max-height: 150px;">
    @endif
</div>
