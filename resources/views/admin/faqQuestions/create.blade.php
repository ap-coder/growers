...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="fas fa-plus mr-2"></i> {{ trans('global.create') }} {{ trans('cruds.faqQuestion.title_singular') }}</h5>
    </div>
            ...
            <div class="card card-outline card-success mb-3">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('question') ? 'is-invalid' : '' }}" name="question" id="question" rows="2" required>{{ old('question') }}</textarea>
                    ...
                    <div class="form-group mb-0">
                        ...
                        <textarea class="form-control {{ $errors->has('answer') ? 'is-invalid' : '' }}" name="answer" id="answer" rows="4" required>{{ old('answer') }}</textarea>
