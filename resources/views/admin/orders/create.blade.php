    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('ordered_by_name') ? 'is-invalid' : '' }}" type="text" name="ordered_by_name" id="ordered_by_name" value="{{ old('ordered_by_name', '') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('ordered_by_phone') ? 'is-invalid' : '' }}" type="text" name="ordered_by_phone" id="ordered_by_phone" value="{{ old('ordered_by_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('special_request') ? 'is-invalid' : '' }}" name="special_request" id="special_request" rows="3">{{ old('special_request') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('delivery_details') ? 'is-invalid' : '' }}" name="delivery_details" id="delivery_details" rows="2">{{ old('delivery_details') }}</textarea>
