...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.clientPrice.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.client-prices.update", [$clientPrice->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <div class="form-check {{ $errors->has('published') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="published" value="0">
                    <input class="form-check-input" type="checkbox" name="published" id="published" value="1" {{ $clientPrice->published || old('published', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $clientPrice->price) }}" step="0.01">
                @if($errors->has('price'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sku') ? 'is-invalid' : '' }}" type="text" name="sku" id="sku" value="{{ old('sku', $clientPrice->sku) }}">
                @if($errors->has('sku'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mpn') ? 'is-invalid' : '' }}" type="text" name="mpn" id="mpn" value="{{ old('mpn', $clientPrice->mpn) }}">
                @if($errors->has('mpn'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gtin') ? 'is-invalid' : '' }}" type="text" name="gtin" id="gtin" value="{{ old('gtin', $clientPrice->gtin) }}">
                @if($errors->has('gtin'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('upc') ? 'is-invalid' : '' }}" type="text" name="upc" id="upc" value="{{ old('upc', $clientPrice->upc) }}">
                @if($errors->has('upc'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qb_1') ? 'is-invalid' : '' }}" type="text" name="qb_1" id="qb_1" value="{{ old('qb_1', $clientPrice->qb_1) }}">
                @if($errors->has('qb_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qb_2') ? 'is-invalid' : '' }}" type="text" name="qb_2" id="qb_2" value="{{ old('qb_2', $clientPrice->qb_2) }}">
                @if($errors->has('qb_2'))
