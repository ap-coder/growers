...
<html lang="en">
				...
				<div class="header-nav w3menu navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
					...
					<ul class=" nav navbar-nav">
						<li class="has-mega-menu sub-menu-down auto-width menu-left">
							<a href="index.html"><span>Home</span><i class="fas fa-chevron-down tabindex" ></i></a>
						</li>
						<li class="has-mega-menu sub-menu-down">
							...
							<div class="mega-menu shop-menu">
								<ul>
										...
										<ul>
											...
											<li><span class="menu-title">Shop Pages</span>
												<ul>						
													...
													<li><a href="forget-password.html">Forget Password <div class="badge badge-sm rounded badge-animated">New</div></a></li>
												</ul>
											</li>
											<li class="month-deal">
												<div class="clearfix me-3">
													<h3>Deal of the month</h3>
													<p class="mb-0">Yes! Send me exclusive offers, personalised, and unique gift ideas, tips for shopping on PlantZone <a href="shop-standard.html" class="dz-link-2">View All Products</a></p>
												</div>
									...
									<li class="side-right">
										<div class="adv-media">
											<img src="{{ asset('assets/images/adv-1.png') }}" alt="/">
										</div>
									</li>
								</ul>
							</div>
												...
												<ul>
													<li>
														...
														<div class="dz-content">
															<h6 class="name"><a href="post-standard.html">A Journey Through Plant</a></h6>
															<span class="time">Jun 23, 2024</span>
														</div>
													</li>
													<li>
														<div class="dz-media">
															<img src="{{ asset('assets/images/shop/product/small/2.png') }}" alt="">
														</div>
														<div class="dz-content">
															<h6 class="name"><a href="post-standard.html">Into Plant Care Cultivation</a></h6>
															<span class="time">Feb 16, 2024</span>
														</div>
													</li>
													<li>
														<div class="dz-media">
															<img src="{{ asset('assets/images/shop/product/small/3.png') }}" alt="">
														</div>
														<div class="dz-content">
															<h6 class="name"><a href="post-standard.html">
																The Wonders of Plants</a></h6>
										...
										<ul class="portfolio-nav-link">
											<li>
												<a href="portfolio-tiles.html">
													<img src="{{ asset('assets/images/portfolio/icons/portfolio-tiles.svg') }}" alt="/">
													<span>Portfolio Tiles</span>
												</a>
											</li>
											<li>
												<a href="collage-style-1.html">
													<img src="{{ asset('assets/images/portfolio/icons/collage-style-1.svg') }}" alt="/">
													<span>Collage Style 1</span>
												</a>
											</li>
											<li>
												<a href="collage-style-2.html">
													<img src="{{ asset('assets/images/portfolio/icons/collage-style-2.svg') }}" alt="/">
													<span>Collage Style 2</span>
												</a>
											</li>
											<li>
												<a href="masonry-grid.html">
													<img src="{{ asset('assets/images/portfolio/icons/masonry-grid.svg') }}" alt="/">
													<span>Masonry Grid</span>
												</a>
											</li>
											<li>
												<a href="cobble-style-1.html">
													<img src="{{ asset('assets/images/portfolio/icons/cobble-style-1.svg') }}" alt="/">
													<span>Cobble Style 1</span>
												</a>
											</li>
											<li>
												<a href="cobble-style-2.html">
													<img src="{{ asset('assets/images/portfolio/icons/cobble-style-2.svg') }}" alt="/">
													<span>Cobble Style 2</span>
												</a>
											</li>
											<li>
												<a href="portfolio-thumbs-slider.html">
													<img src="{{ asset('assets/images/portfolio/icons/portfolio-thumbs-slider.svg') }}" alt="/">
													<span>Portfolio Thumbs Slider</span>
												</a>
											</li>
											<li>
												<a href="portfolio-film-strip.html">
													<img src="{{ asset('assets/images/portfolio/icons/portfolio-film-strip.svg') }}" alt="/">
													<span>Portfolio Film Strip</span>
												</a>
											</li>
											<li>
												<a href="carousel-showcase.html">
													<img src="{{ asset('assets/images/portfolio/icons/carousel-showcase.svg') }}" alt="/">
													<span>Carousel Showcase</span>
												</a>
											</li>
											<li>
												<a href="portfolio-split-slider.html">
													<img src="{{ asset('assets/images/portfolio/icons/portfolio-split-slider.svg') }}" alt="/">
						...
						<li class="sub-menu-down">
							<a href="javascript:void(0);"><span>My Account <span class="badge badge-sm rounded badge-animated">New</span></span><i class="fas fa-chevron-down tabindex"></i></a>
							<ul class="sub-menu">						
								<li><a href="account-dashboard.html">Dashboard</a></li>
								<li><a href="account-orders.html">Orders</a></li>
								<li><a href="account-order-details.html">Orders Details</a></li>
			...
			<div class="container">
				<form class="header-item-search">
					...
					<ul class="recent-tag">
						...
						<li><a href="shop-list.html">Small Plants</a></li>
						<li><a href="shop-list.html">House Plants</a></li>
						<li><a href="shop-list.html">Aqua Greens</a></li>
						<li><a href="shop-list.html">Plant Paradise</a></li>
					</ul>
				</form>
							...
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<div class="shop-card">
										...
										<div class="dz-content">
											<h3 class="title"><a href="shop-list.html">Large Majesty Palm (m)</a></h3>
								...
								<div class="swiper-slide">
									<div class="shop-card">
										...
										<div class="dz-content">
											<h3 class="title"><a href="shop-list.html">Endless Stems Gardens (m)</a></h3>
								...
								<div class="swiper-slide">
									<div class="shop-card">
										...
										<div class="dz-content">
											<h3 class="title"><a href="shop-list.html">Long Strider Pants (m)</a></h3>
								...
								<div class="swiper-slide">
									<div class="shop-card">
										...
										<div class="dz-content">
											<h3 class="title"><a href="shop-list.html">Feather Reed Grass (m)</a></h3>
								...
								<div class="swiper-slide">
									<div class="shop-card">
										...
										<div class="dz-content">
											<h3 class="title"><a href="shop-list.html">Miniature Rose Bush (m)</a></h3>
								...
								<div class="swiper-slide">
									<div class="shop-card">
										...
										<div class="dz-content">
											<h3 class="title"><a href="shop-list.html">Giant Elephant Ear(M)</a></h3>
								...
								<div class="shop-sidebar-cart">
									<ul class="sidebar-cart-list">
										<li>
											<div class="cart-widget">
												<div class="dz-media me-3">
													<img src="{{ asset('assets/images/shop/shop-cart/pic1.jpg') }}" alt="">
												</div>
												<div class="cart-content">
													<h6 class="title"><a href="product-thumbnail.html">Large Majesty Palm (m)</a></h6>
													<div class="d-flex align-items-center">
														<div class="btn-quantity light quantity-sm me-3 ms-0 style-1">
															<input type="text" value="1" name="demo_vertical2">
														</div>
														<h6 class="dz-price mb-0">$59 <del>$99</del></h6>
													</div>
												</div>
										...
										<li>
											<div class="cart-widget">
												<div class="dz-media me-3">
													<img src="{{ asset('assets/images/shop/shop-cart/pic2.jpg') }}" alt="">
												</div>
												<div class="cart-content">
													<h6 class="title"><a href="product-thumbnail.html">Endless Stems Gardens (m)</a></h6>
													<div class="d-flex align-items-center">
														<div class="btn-quantity light quantity-sm me-3 ms-0 style-1">
															<input type="text" value="1" name="demo_vertical2">
														</div>
														<h6 class="dz-price mb-0">$79 <del>$99</del></h6>
													</div>
												</div>
												<a href="javascript:void(0);" class="dz-close">
													<i class="ti-close"></i>
										...
										<li>
											<div class="cart-widget">
												<div class="dz-media me-3">
													<img src="{{ asset('assets/images/shop/shop-cart/pic3.jpg') }}" alt="">
												</div>
												<div class="cart-content">
													<h6 class="title"><a href="product-thumbnail.html">Feather Reed Grass (m)</a></h6>
													<div class="d-flex align-items-center">
														<div class="btn-quantity light quantity-sm me-3 ms-0 style-1">
															<input type="text" value="1" name="demo_vertical2">
														</div>
														<h6 class="dz-price mb-0">$49 <del>$99</del></h6>
													</div>
												</div>
												<a href="javascript:void(0);" class="dz-close">
													<i class="ti-close"></i>
										...
										<li>
											<div class="cart-widget">
												...
												<div class="cart-content">
													<h6 class="title"><a href="product-thumbnail.html">Long Strider Pants (m)</a></h6>
													<div class="d-flex align-items-center">
														<div class="btn-quantity light quantity-sm me-3 ms-0 style-1">
															<input type="text" value="1" name="demo_vertical2">
														</div>
														<h6 class="dz-price mb-0">$99 <del>$199</del></h6>
													</div>
												</div>
												<a href="javascript:void(0);" class="dz-close">
													<i class="ti-close"></i>
				...
				<div class="contact-sidebar">
					<div class="contact-box1 deznav-scroll">
						<div class="logo-contact logo-header m-0">
							<a href="index.html" class="logo-white"><img src="{{ asset('assets/images/logo.svg') }}" alt="/"></a>
						</div>
						...
						<form class="dzSubscribe dz-subscribe-wrapper1" action="script/mailchamp.php" method="post">
							...
							<div class="form-group">
								...
								<div class="custom-control custom-checkbox d-flex m-b40">
									...
									<label class="form-check-label">I Agree To The <span><a href="privacy-policy.html">Privacy Policy</a></span></label>
								</div>
							</div>
						</form>
	...
	<!-- Header End -->
		...
		<div class="page-content">@include('shop.cart')
		...
		<footer class="site-footer style-2">
			...
			<div class="footer-top">
						...
						<div class="col-xl-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.2s">
							<div class="widget widget_post">
								...
								<ul>
									<li>
										<div class="dz-media">
											<a href="post-standard.html"><img src="{{ asset('assets/images/shop/product/small/1.png') }}" alt=""></a>
										</div>
									</li>
									<li>
										<div class="dz-media">
											<a href="post-standard.html"><img src="{{ asset('assets/images/shop/product/small/2.png') }}" alt=""></a>
										</div>
									</li>
									<li>
										<div class="dz-media">
											<a href="post-standard.html"><img src="{{ asset('assets/images/shop/product/small/3.png') }}" alt=""></a>
										</div>
									</li>
									<li>
										<div class="dz-media">
											<a href="post-standard.html"><img src="{{ asset('assets/images/shop/product/small/4.png') }}" alt=""></a>
										</div>
									</li>
									<li>
										<div class="dz-media">
											<a href="post-standard.html"><img src="{{ asset('assets/images/shop/product/small/5.png') }}" alt=""></a>
										</div>
									</li>
									<li>
										<div class="dz-media">
											<a href="post-standard.html"><img src="{{ asset('assets/images/shop/product/small/6.png') }}" alt=""></a>
										</div>
									</li>
								</ul>
							</div>
				...
				<img class="Plant-img wow fadeInLeft" data-wow-delay="0.8s" src="{{ asset('assets/images/Plant-1.png') }}" alt="">
				<img class="Plant-img2 wow fadeInRight" data-wow-delay="0.8s" src="{{ asset('assets/images/Plant-2.png') }}" alt="">
			</div>
			<!-- Footer Top End -->
				...
				<div class="container">
					<div class="row fb-inner wow fadeInUp" data-wow-delay="0.1s">
						<div class="col-lg-6 col-md-12 text-start"> 
							<p class="copyright-text">© <span class="current-year">2024</span> <a href="https://www.dexignzone.com/">DexignZone</a> Theme. All Rights Reserved.</p>
						</div>
						<div class="col-lg-6 col-md-12 text-end"> 
							<div class="d-flex align-items-center justify-content-center justify-content-md-center justify-content-xl-end">
								<img src="{{ asset('assets/images/footer-img2.png') }}" alt="">
							</div>
						</div>
					</div>
				</div>
