...
class FaqCategoryController extends Controller
{
    ...
    {
        abort_if(Gate::denies('site_faq_category_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('site_faq_category_create'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('site_faq_category_edit'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('site_faq_category_show'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('site_faq_category_delete'), Response::HTTP_FORBIDDEN, '403 Forbidden');
