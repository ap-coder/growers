...
class ContentTagController extends Controller
{
    ...
    {
        abort_if(Gate::denies('site_content_tag_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('site_content_tag_create'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('site_content_tag_edit'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('site_content_tag_show'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('site_content_tag_delete'), Response::HTTP_FORBIDDEN, '403 Forbidden');
