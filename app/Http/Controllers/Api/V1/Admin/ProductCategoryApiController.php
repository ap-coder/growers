...
class ProductCategoryApiController extends Controller
{
    ...
    {
        abort_if(Gate::denies('api_product_category_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('api_product_category_show'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('api_product_category_delete'), Response::HTTP_FORBIDDEN, '403 Forbidden');
