                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.order-items.update", [$orderItem->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gtin" id="gtin" value="{{ old('gtin', $orderItem->gtin) }}">
                            @if($errors->has('gtin'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('gtin') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sku" id="sku" value="{{ old('sku', $orderItem->sku) }}">
                            @if($errors->has('sku'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sku') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mpn" id="mpn" value="{{ old('mpn', $orderItem->mpn) }}">
                            @if($errors->has('mpn'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('mpn') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_price" id="total_price" value="{{ old('total_price', $orderItem->total_price) }}" step="0.01">
